...
def main():
    """
    Hlavní funkce programu pro evidenci pojištění.

    Tato funkce spouští hlavní smyčku programu, ve které uživatel může provádět různé akce,
    jako je přidávání, výpis a vyhledávání pojištěných uživatelů.
